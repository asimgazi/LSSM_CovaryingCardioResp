function compare_CBproducts(plotTitle, fileName, Cparams1, Cparams2, ...
    featNames, Bparams1, Bparams2, inputsOpt, groupNames)
...
for sub = 1:numel(Cparams1)
    CBproducts1(:, :, sub) = transpose(Cparams1{sub}*Bparams1{sub});
end
for sub = 1:numel(Cparams2)
    CBproducts2(:, :, sub) = transpose(Cparams2{sub}*Bparams2{sub});
end
